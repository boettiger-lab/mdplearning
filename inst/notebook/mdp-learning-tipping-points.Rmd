...
df <- mdp_planning(C_matrices[[true_i]], utility, discount, x0 = 30, Tmax = Tmax, policy = unif$policy)
```
...
sims <- 
map_df(1:100, 
       function(i) mdp_planning(C_matrices[[true_i]], utility, discount, x0 = 30, Tmax = Tmax, policy = unif$policy),
  .id = "rep")
...
sims <- 
map_df(1:100, 
       function(i) mdp_planning(C_matrices[[true_i]], reward = utility, discount = discount, x0 = 30, Tmax = Tmax, observation = observation, policy = unif$policy),
  .id = "rep")
